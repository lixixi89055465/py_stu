...
def main():
    ...
    fc_net = Sequential([
        ...
        layers.Dense(4096, activation=tf.nn.relu, kernel_regularizer=regularizers.l2(0.1)),
        layers.Dropout(0.5),
        ...
        layers.Dropout(0.5),
        layers.Dense(100, activation=tf.nn.relu, kernel_regularizer=regularizers.l2(0.1)),
        layers.Dropout(0.5),
