...
Original file is located at
    https://colab.research.google.com/drive/1Sjz5IWrtq0HWW_oEH99N1_piD5PqKBuq
...
# accuracy=0.6874
# accuracy=0.7222  -> d_model=160
# accuracy=0.7494,0.88071 -> d_model=160     total_steps=140000,
# accuracy=0.6967  -> d_model=320
# dropout=0.01 ,d_model=160 ,dim_feedforward=512, accuracy=0.7503  0.90904
# dropout=0.01 ,d_model=160 ,dim_feedforward=1024, accuracy=0.7913 0.91309
# dropout=0.01 ,d_model=160 ,dim_feedforward=2048, accuracy=0.8053
# dropout=0.2 ,d_model=160 ,dim_feedforward=2048, accuracy=0.7925
# dropout=0.3 ,d_model=160 ,dim_feedforward=2048, accuracy=0.7918
# dropout=0.5 ,d_model=160 ,dim_feedforward=2048, accuracy=0.6925
...
def main(
    ...
    for step in range(total_steps):
        ...
        if (step + 1) % save_steps == 0 and best_state_dict is not None:
            ...
            pbar.write(f"Step {step + 1}, best model saved. (accuracy={best_accuracy:.4f}),lr:{optimizer.param_groups[0]['lr']}")
