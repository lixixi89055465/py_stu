    ...
    for epoch in range(n_epoch):
        ...
        if epoch % 20 == 19:
            ...
            with torch.no_grad():
                ...
                # targetNum=[i for i in range(len(unlabel.sampler.data_source.data ))].remove() for i in canIndex_input
                ...
                print('unlabel.sampler.data_source.data.len:', len(unlabel.sampler.data_source.data))
                print('train.sampler.data_source.data:', len(train.sampler.data_source.data))
