...
def get_pseudo_labels(model, unlable_dataset, semi_dataset, threshold=0.650):
    ...
    # train_set = DatasetFolder("../data/food-11/training/labeled", loader=lambda x: Image.open(x), extensions="jpg",
    #                           transform=train_tfm)
    # semi_dataset = DatasetFolder("../data/food-11/training/labeled",loader=lambda x: Image.open(x), extensions="jpg", transform=train_tfm)
    # unlabeled_dataset =  DatasetFolder("../data/food-11/training/labeled",loader=lambda x: Image.open(x), extensions="jpg", transform=train_tfm)
...
do_semi = True
semi_pi = 0.1
semi_dataset = DatasetFolder("../data/food-11/training/labeled", loader=lambda x: Image.open(x), extensions="jpg",
                             transform=train_tfm)
semi_dataset.samples = []
semi_dataset.targets = []
unlabel_dataset =  DatasetFolder("../data/food-11/training/unlabeled", loader=lambda x: Image.open(x), extensions="jpg",
                              transform=train_tfm)
