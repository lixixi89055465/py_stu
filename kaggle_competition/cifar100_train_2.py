...
def main():
    ...
    fc_net = Sequential([
        ...
        # layers.Dense(256, activation=tf.nn.relu, kernel_regularizer=regularizers.l2(0.1)),
        layers.Dense(256, activation=tf.nn.relu, kernel_regularizer=regularizers.l1(0.01)),
        layers.Dropout(0.5),
        # layers.Dense(128, activation=tf.nn.relu,kernel_regularizer=regularizers.l2(0.01)),
        # layers.Dense(128, activation=tf.nn.relu, kernel_regularizer=regularizers.l2(0.1)),
        layers.Dense(256, activation=tf.nn.relu, kernel_regularizer=regularizers.l1(0.01)),
        layers.Dropout(0.5),
