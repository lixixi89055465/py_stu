...
if force_recreate_dir == False and os.path.exists(data_dir + input_dir) and os.path.exists(
        data_dir + input_dir + train_dir) and os.path.exists(data_dir + input_dir + test_dir):
...
def data_loader(batch_size, transform_train, transform_test=None):
    ...
    train_valid_ds = vision.ImageFolderDataset(data_dir + "/" + input_dir + '/train_valid', flag=1,
...
model_list = ['resnet164_e255_focal_clip', 'res164__2_e255_focal_clip_all_data', 'resnet164_e300',
              'resnet164_e0-255_focal_clip',
              'res18_9',
