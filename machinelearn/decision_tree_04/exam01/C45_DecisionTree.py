...
class C45_DecisionTree:
    ...
    def __init__(self, min_info_gain, feature_names):
        ...
        self.cal_info_gain = Entropy_Utils().info_gain_rate# 计算信息增益函数
...
# 通过C45 算法生产决策树
C45 = C45_DecisionTree(epsilon, feature_names)
print('=' * 100)
print('start training ')
tree = C45.fit(X_train, y_train)
time_3 = time()
print(f'training cost {time_3 - time_2} seconds ')
print('=' * 100)
print('start predicting ')
y_test, y_test_pred = C45.predict(X_test, y_test, tree)
time_4 = time()
