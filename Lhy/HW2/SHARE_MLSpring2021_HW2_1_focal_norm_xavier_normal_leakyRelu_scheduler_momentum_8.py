...
# scheduler_real = torch.optim.lr_scheduler.StepLR(optimizer1, step_size=20, gamma=0.1)
...
with open('SHARE_MLSpring2021_HW2_1_focal_norm_xavier_normal_leakyRelu_4.py.csv', 'w') as f:
    f.write('Id,Class\n')
