...
# # Dataset module
# 
# Module for obtaining and processing images. The transform function here normalizes image's pixels from [0, 255] to [-1.0, 1.0].
# 
...
# prediction file 
out_file = 'PREDICTION_FILE_02.csv'
